package com.jinu.spring.test.mybatis;
...
import com.jinu.spring.test.mybatis.domain.RealEstate;
import com.jinu.spring.test.mybatis.service.RealEstateService;
...
public class RealEstateController {
	...
	public String createRealEstate(@RequestParam("realtorId") int realtorId) {
		...
		int count = realEstateService.addRealEstate(realtorId, "썅떼빌리버 오피스텔 814호", 45, "월세", 10000, 120);
